...
class CreateAnEventFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        createEventButton.setOnClickListener {
            Toast.makeText(context, "Я открою страницу создания мероприятия", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun setMyEventAdapter(events: ArrayList<Event>, view: View, context: Context){ //Адаптер текущих игр
        ...
        val presenceAdapter = PresenceAdapter(events, context) //внесение данных из листа в адаптер (заполнение данными)
...
//            context.startActivity(i)
    ...
    private fun init(view: View) {
        ...
        createEventButton = view.findViewById<MaterialButton>(R.id.create_event_button)
    }
}