package com.example.eventsystemresponsibleapp.Adapter
...
class PresenceAdapter(private val events: ArrayList<Event>, private val context: Context): RecyclerView.Adapter<PresenceAdapter.MyViewHolder>()  {
